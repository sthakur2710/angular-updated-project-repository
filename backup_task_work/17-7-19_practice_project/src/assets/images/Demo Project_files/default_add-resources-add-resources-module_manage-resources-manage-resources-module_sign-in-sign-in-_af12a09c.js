(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~add-resources-add-resources-module~manage-resources-manage-resources-module~sign-in-sign-in-~af12a09c"],{
...
Links.fbProvider = '1769326306468731';
Links.googleProvider = '904902362920-cf2j63qqlkdou3hq2qbkos8sdmi9uk5v.apps.googleusercontent.com';
...
Links.base = 'http://localhost/api/';
Links.LOGIN = Links.base + 'admin/login';
Links.SIGNUP = Links.base + 'admin/signup';
Links.ADDRESOURCE = Links.base + 'admin/add_resources';
Links.GETALLRESOURCES = Links.base + 'admin/get_manage_resources';
...
/* harmony import */ var _links_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../links.module */ "./src/app/links.module.ts");
...
let LoginService = class LoginService {
    ...
    authenticateUser(data) {
        ...
        //   };
        return this.http.post(_links_module__WEBPACK_IMPORTED_MODULE_5__["Links"].LOGIN, data)
            .map((response) => response);
    }
    CreateUser(data) {
        return this.http.post(_links_module__WEBPACK_IMPORTED_MODULE_5__["Links"].SIGNUP, data).map((response) => response);
    }
    add_resource(data) {
        return this.http.post(_links_module__WEBPACK_IMPORTED_MODULE_5__["Links"].ADDRESOURCE, data).map((response) => response);
    }
    get_all_resource_details(data) {
        console.log(data);
        return this.http.post(_links_module__WEBPACK_IMPORTED_MODULE_5__["Links"].GETALLRESOURCES, data).map((response) => response);
    }
    get_resource_details(data) {
        return this.http.post(_links_module__WEBPACK_IMPORTED_MODULE_5__["Links"].GETRESOURCEDETAILS, data).map((response) => response);
    }
};
...
//# sourceMappingURL=default~add-resources-add-resources-module~manage-resources-manage-resources-module~sign-in-sign-in-~af12a09c.js.map